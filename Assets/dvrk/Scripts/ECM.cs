...
namespace DVRK {
    ...
    public class ECM : URDFRobot
    {
        ...
        public override void SendJointStates(UdpJsonSender udpsend, bool moving)
        {
            ...
            //Sends ECM World Position and Rotation for Simulation Cameras
            Vector3 normalizedPos = independentJoints[3].transform.position - transform.parent.parent.parent.parent.parent.parent.parent.parent.GetChild(0).position;
            Debug.Log("ECM: " + normalizedPos + " RCM Position: " + independentJoints[3].transform.position + "Shell position: " + transform.parent.parent.parent.parent.parent.parent.parent.parent.GetChild(0).position);

            udpsend.states = new float[] { normalizedPos.x, normalizedPos.y, normalizedPos.z,
                independentJoints[0].currentJointValue, independentJoints[1].currentJointValue,
                //independentJoints[3].transform.GetChild(0).eulerAngles.y
                RCM.rotation.eulerAngles.y};
        }
